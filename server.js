...
function normalizeResponse(body) {
  ...
  return {
    ...
    mesa_soporte: shownValue(mesaSi, body.mesa_soporte),
    mesa_espera: shownValue(mesaSi, body.mesa_espera || body.mesa_tiempo),
    mesa_resolucion: shownValue(mesaSi, body.mesa_resolucion || body.mesa_primerContacto),
    mesa_amabilidad: shownValue(mesaSi, body.mesa_amabilidad),
    mesa_conocimiento: shownValue(mesaSi, body.mesa_conocimiento || body.mesa_atencion),
    mesa_trato: shownValue(mesaSi, body.mesa_trato),
    // Compatibilidad con respuestas antiguas del tablero
    ...
    mesa_atencion: shownValue(mesaSi, body.mesa_atencion || body.mesa_conocimiento || body.mesa_amabilidad),
