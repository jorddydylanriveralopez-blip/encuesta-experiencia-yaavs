(() => {
  ...
  const LABELS = [
    ...
    ["visitaEjecutivo", "Frecuencia de visita del ejecutivo de ventas"],
    ["ejecutivo", "Calificación del ejecutivo de ventas"],
    ["mesaUso", "¿Solicitó apoyo a Mesa de Control?"],
    ["mesa_soporte", "Mesa · Soporte recibido"],
    ["mesa_espera", "Mesa · Tiempo de espera para ser atendido"],
    ["mesa_resolucion", "Mesa · Resolución de dudas o problemas"],
    ["mesa_amabilidad", "Mesa · Amabilidad y empatía del ejecutivo de atención al cliente"],
    ["mesa_conocimiento", "Mesa · Conocimiento y claridad del ejecutivo de atención al cliente"],
    ["mesa_trato", "Mesa · Trato recibido durante la interacción"],
    ["mesaMejoras", "Mejoras Mesa de Control"],
    ["recargaMetodo", "Principal medio para activar chips"],
    ["recargaUso", "¿Usó la app RecargaKlic?"],
    ["recargaExp", "Experiencia general con RecargaKlic"],
    ["recargaMejora", "Aspecto a mejorar en RecargaKlic"],
    ["popUso", "¿Recibió material publicitario para su punto de venta?"],
    ["popSat", "Satisfacción con material publicitario en punto de venta"],
    ["popMejora", "Aspecto a mejorar del material publicitario"],
