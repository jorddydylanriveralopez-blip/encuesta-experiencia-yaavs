(() => {
  ...
  const LABELS = [
    ...
    ["mesa_espera", "Tiempo de espera para ser atendido"],
    ["mesa_resolucion", "Resolución de dudas o problemas"],
    ["mesa_amabilidad", "Amabilidad y empatía del ejecutivo de atención al cliente"],
    ["mesa_conocimiento", "Conocimiento y claridad del ejecutivo de atención al cliente"],
    ["mesa_trato", "Trato recibido durante la interacción"],
